...
class MotChallenge2DBox(_BaseDataset):
    ...
    def get_default_dataset_config():
        ...
        default_config = {
            ...
            'CLASSES_TO_EVAL': ['vehicle'],  # Valid: ['pedestrian']
    ...
    def __init__(self, config=None):
        ...
        self.class_name_to_class_id = {'vehicle': 100, 'pedestrian': 1, 'person_on_vehicle': 2, 'car': 3, 'bicycle': 4, 'motorbike': 5,
